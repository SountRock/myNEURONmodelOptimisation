...
'''
Практически копия основного скрипта оптимизации, но больше для проверки результатов графически
'''
...
with open('init_7.json', 'r') as json_file:
...
plt.plot(t_matrix[0], ys[0], marker='o', linestyle='-', color='r', label='Optim Curve')
plt.plot(t_matrix[0], y_true_matrix[0], marker='o', linestyle='-', color='g', label='Target Curve')
plt.xlabel('Stim freq (Hz)')
plt.ylabel('Spikes per cycle')
plt.legend()
plt.grid(True)
plt.savefig('targerFreqFuncAllPathActive.png')

#========================================
plt.figure(figsize=(10, 6))
plt.plot(t_matrix[1], ys[1], marker='o', linestyle='-', color='r', label='Optim Curve')
plt.plot(t_matrix[1], y_true_matrix[1], marker='o', linestyle='-', color='g', label='Target Curve')
plt.xlabel('Stim freq (Hz)')
plt.ylabel('Spikes per cycle')
plt.legend()
plt.grid(True)
plt.savefig('targerFreqFuncPSDCPathOff.png')

#========================================
plt.figure(figsize=(10, 6))
plt.plot(t_matrix[2], ys[2], marker='o', linestyle='-', color='r', label='Optim Curve')
plt.plot(t_matrix[2], y_true_matrix[2], marker='o', linestyle='-', color='g', label='Target Curve')
plt.xlabel('Stim freq (Hz)')
plt.ylabel('PLP')
plt.legend()
plt.grid(True)
plt.savefig('targerFreqFuncAllPathActivePLP.png')

#========================================
plt.figure(figsize=(10, 6))
plt.plot(t_matrix[3], ys[3], marker='o', linestyle='-', color='r', label='Optim Curve')
plt.plot(t_matrix[3], y_true_matrix[3], marker='o', linestyle='-', color='g', label='Target Curve')
plt.xlabel('Stim freq (Hz)')
plt.ylabel('PLP')
plt.legend()
plt.grid(True)
plt.savefig('targerFreqFuncPSDCPathOffPLP.png')

#========================================


plt.figure(figsize=(10, 6))
plt.plot(t_matrix[4], ys[4], marker='o', linestyle='-', color='r', label='Optim Curve')
plt.plot(t_matrix[4], y_true_matrix[4], marker='o', linestyle='-', color='g', label='Target Curve')
plt.xlabel('Stim freq (Hz)')
plt.ylabel('Hz')
plt.legend()
plt.grid(True)
plt.savefig('targerFreqFuncAllPathActiveFreq.png')

#========================================
plt.figure(figsize=(10, 6))
plt.plot(t_matrix[5], ys[5], marker='o', linestyle='-', color='r', label='Optim Curve')
plt.plot(t_matrix[5], y_true_matrix[5], marker='o', linestyle='-', color='g', label='Target Curve')
plt.xlabel('Stim freq (Hz)')
plt.ylabel('Hz')
plt.legend()
plt.grid(True)
plt.savefig('targerFreqFuncPSDCPathOffFreq.png')


#========================================
plt.figure(figsize=(10, 6))
plt.plot(t_matrix[6], ys[6], marker='o', linestyle='-', color='r', label='Optim Curve')
plt.plot(t_matrix[6], y_true_matrix[6], marker='o', linestyle='-', color='g', label='Target Curve')
plt.xlabel('Stim freq (Hz)')
plt.ylabel('')
plt.legend()
plt.grid(True)
plt.savefig('targerPressureFunc.png')
