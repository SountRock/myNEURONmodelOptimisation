...
#define nrn_init _nrn_init__Izhi2007bmod
#define _nrn_initial _nrn_initial__Izhi2007bmod
#define nrn_cur _nrn_cur__Izhi2007bmod
#define _nrn_current _nrn_current__Izhi2007bmod
#define nrn_jacob _nrn_jacob__Izhi2007bmod
#define nrn_state _nrn_state__Izhi2007bmod
#define _net_receive _net_receive__Izhi2007bmod 
...
#define omega _p[13]
#define omega_columnindex 13
#define Aosc _p[14]
#define Aosc_columnindex 14
#define i _p[15]
#define i_columnindex 15
#define u _p[16]
#define u_columnindex 16
#define delta _p[17]
#define delta_columnindex 17
#define t0 _p[18]
#define t0_columnindex 18
#define derivtype _p[19]
#define derivtype_columnindex 19
#define _g _p[20]
...
extern "C" {
 ...
 static double _hoc_derivfunc(void*);
...
#define derivfunc derivfunc_Izhi2007bmod
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 22, 11);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Izhi2007bmod izhi2007bmod.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   if ( celltype  == 8.0 ) {
     u = u + delta * a * ( b * ( v - vr ) - u ) ;
     i = - ( k * ( v - vr ) * ( v - vt ) - u + Iin + Aosc * sin ( omega * t ) ) / C / 1000.0 ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "izhi2007bmod.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  ...
  "NEURON {\n"
  "  POINT_PROCESS Izhi2007bmod\n"
  "  RANGE C, k, vr, vt, vpeak, u, a, b, c, d, Iin, celltype, alive, cellid, verbose, derivtype, delta, t0, omega, Aosc\n"
  ...
  "\n"
  "  : For Resonator neurons\n"
  "  if (celltype == 8) {\n"
  "    u = u + delta * a * (b * (v - vr) - u)\n"
  "    i = -(k * (v - vr) * (v - vt) - u + Iin + Aosc * sin(omega * t)) / C / 1000\n"
  "  } else {\n"
  "    i = -(k * (v - vr) * (v - vt) - u + Iin) / C / 1000\n"
  "  }\n"
  "}\n"
