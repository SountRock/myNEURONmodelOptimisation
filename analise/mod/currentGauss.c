...
#define nrn_init _nrn_init__current_gauss
#define _nrn_initial _nrn_initial__current_gauss
#define nrn_cur _nrn_cur__current_gauss
#define _nrn_current _nrn_current__current_gauss
#define nrn_jacob _nrn_jacob__current_gauss
#define nrn_state _nrn_state__current_gauss
#define _net_receive _net_receive__current_gauss 
#define seed seed__current_gauss 
...
#define std0 _p[3]
#define std0_columnindex 3
#define std _p[4]
#define std_columnindex 4
#define noise_seed _p[5]
#define noise_seed_columnindex 5
#define f0 _p[6]
#define f0_columnindex 6
#define in _p[7]
#define in_columnindex 7
#define rand _p[8]
#define rand_columnindex 8
#define count _p[9]
#define count_columnindex 9
#define N_smooth _p[10]
#define N_smooth_columnindex 10
#define _g _p[11]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 current_gauss currentGauss.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Internal noisy channel";
...
{
 {
   N_smooth = floor ( 1000.0 / f0 / dt ) * 2.0 ;
   std = std0 / sqrt ( 4000.0 / f0 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "currentGauss.mod";
static const char* nmodl_file_text = 
