...
#define d _p[3]
#define d_columnindex 3
#define f _p[4]
#define f_columnindex 4
#define g _p[5]
#define g_columnindex 5
#define Iin _p[6]
#define Iin_columnindex 6
#define taug _p[7]
#define taug_columnindex 7
#define thresh _p[8]
#define thresh_columnindex 8
#define erev _p[9]
#define erev_columnindex 9
#define fflag _p[10]
#define fflag_columnindex 10
#define u _p[11]
#define u_columnindex 11
#define V _p[12]
#define V_columnindex 12
#define gsyn _p[13]
#define gsyn_columnindex 13
#define Du _p[14]
#define Du_columnindex 14
#define DV _p[15]
#define DV_columnindex 15
#define Dgsyn _p[16]
#define Dgsyn_columnindex 16
#define v _p[17]
...
extern "C" {
 ...
 static double _hoc_version(void*);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Izhi2003a izhi2003a.mod\n");
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = V_columnindex;  _dlist1[0] = DV_columnindex;
 _slist1[1] = u_columnindex;  _dlist1[1] = Du_columnindex;
 _slist1[2] = gsyn_columnindex;  _dlist1[2] = Dgsyn_columnindex;
 _slist2[0] = V_columnindex;
 _slist2[1] = gsyn_columnindex;
 _slist2[2] = u_columnindex;
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "izhi2003a.mod";
static const char* nmodl_file_text = 
